 ...
 * @param moonPhase          月相描述(随 Accept-Language 切换 zh/en/ja)
 * @param bortleLevel        Bortle 暗空等级 1-9
 * @param bortleDescription  Bortle 等级描述(随 Accept-Language 切换 zh/en/ja)
 * @param message            人类可读消息(随 Accept-Language 切换 zh/en/ja)
